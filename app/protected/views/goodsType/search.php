...
<div class="pageHeader">
    <div class="topBar">
        <div class="width1200 clearfix">
            <div class="loginArea">
                <span>欢迎光临三体图书网，</span>
                <a href="http://www.bookschina.com/vieworder/default.aspx" rel="nofollow" title="进入个人中心" target="_blank" style="color:#0365B9;" class="login"></a>
                <a href="http://www.bookschina.com/reguser/out.aspx?url=http://tuan.bookschina.com">安全退出</a>

            </div>
            <div class="topNav">
                <a href="http://www.bookschina.com/shopcar/shoppingcart.aspx" rel="nofollow">购物车</a><span>|</span>
                <a href="http://www.bookschina.com/Favorites/Default.aspx" rel="nofollow">收藏夹</a><span>|</span>
                <a href="http://www.bookschina.com/vieworder/listorder.aspx" rel="nofollow">我的订单</a><span>|</span>
                <a href="http://www.bookschina.com/vieworder/default.aspx" rel="nofollow">我的账户</a><span>|</span>
        ...
        <div class="selectorInner">
            <div class="guide_box clearfix">
                ...
                <div class="guide_content">
                    <ul>
                        ...
                        <li class=""><a href="/Home-t1101-c0-r0-o11" title="文学">文学</a></li>
                        <li class=""><a href="/Home-t1103-c0-r0-o11" title="社科">社科</a></li>
                        <li class=""><a href="/Home-t1102-c0-r0-o11" title="童书">童书</a></li>
                        <li class=""><a href="/Home-t1104-c0-r0-o11" title="全部">艺术</a></li>
                        <li class=""><a href="/Home-t1106-c0-r0-o11" title="文教">文教</a></li>
                        <li class=""><a href="/Home-t1107-c0-r0-o11" title="生活">生活</a></li>
                        <li class=""><a href="/Home-t1105-c0-r0-o11" title="其他">其他</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="guide_box clearfix">
                ...
                <div class="guide_content">
                    <ul class="clearfix">
                        <li class="cur"><a href="/Home-t0-c0-r0-o11" title="全部">全部</a></li>
                        <li class=""><a href="/Home-t0-c0-r1-o11" title="30元以下">30元以下</a></li>
                        <li class=""><a href="/Home-t0-c0-r2-o11" title="30－50元">31－50元</a></li>
                        <li class=""><a href="/Home-t0-c0-r3-o11" title="50－100元">50－100元</a></li>
                        <li class=""><a href="/Home-t0-c0-r4-o11" title="100元以上">100元以上</a></li>
                    </ul>
                </div>
            </div>
                ...
                <ul class="clearfix">
                    ...
                    <li class="dtog sortSale ">
                        ...
                        <div class="xiaoliangWrap">
                            <a href="/Home-t0-c0-r0-o40" class="">总销量排行</a>
                            <a href="/Home-t0-c0-r0-o50" class="">近2天销量排行</a>
                            <a href="/Home-t0-c0-r0-o60" class="">近3天销量排行</a>
                            <a href="/Home-t0-c0-r0-o70" class="">近7天销量排行</a>
                            <a href="/Home-t0-c0-r0-o80" class="">近30天销量排行</a>
                        </div>
                    </li>
                </ul>
    ...
    <div class="taoList">
            ...
            <ul id="taoList" class="clearfix">
                <?php foreach($rs as $v){?>
                    <li>
                        ...
                        <div class="infor">
                            <div class="bookCover"><a href="/Tuan/6201"  target="_blank"> <img src="<?php echo ROOT?>/photoView/<?php echo $v['goodsImage']?>" ></a></div>
                            <p class="bookName"><a href="#"  target="_blank"><?php echo $v['author']?></a></p>
                            <p class="bookName2"><a href="#"  target="_blank"><?php echo $v['authorIntro']?></a></p>
                        </div>
                        <div class="price">
                            <span class="salePrice">&yen;<?php echo $v['goodsPrice']*$v['goodsDiscounted']/100?></span>
                        </div>
                        <div class="otherInfor">
                            <span class="dingjia">定价：&yen;<?php echo $v['goodsPrice']?></span><span class="zhekou">折扣:<?php echo $v['goodsDiscounted']/10?>折</span>
                        </div>
                        <div class="buyButton">
                            <a target="_blank" href="/Tuan/6201" class="grounpBuy1">去购买</a>
                        </div>
                        <div class="newicong"></div>
                        <div class="icon"><img src="http://www.bookschina.com/Images/tubiao2.png" style="display:none"  alt="六一儿童节"></div>
                    </li>
                <?php }?>
            </ul>
        </div>
        <div class="page">
                <?php if($currentPage==1){?>
                    <div class="pagelist"> <a href="#">上一页</a> <span class="current"><?php echo $currentPage?></span><a href="<?php echo APP?>/goodsType/search/keyword/<?php echo $keyword?>/page/<?php echo $currentPage+1?>">下一页</a><a href="<?php echo APP?>/goodsType/search/keyword/<?php echo $keyword?>/page/<?php echo $totalPage?>">尾页</a> </div>
                <?php }elseif($currentPage==$totalPage){?>
                    <div class="pagelist"> <a href="<?php echo APP?>/goodsType/search/keyWord/<?php echo $keyword?>/page/<?php echo $currentPage-1?>">上一页</a> <span class="current"><?php echo $currentPage?></span><a href="#">下一页</a><a href="<?php echo APP?>/goodsType/search/keyword/<?php echo $keyword?>/page/<?php echo $totalPage?>">尾页</a> </div>

                <?php }else{?>
                    <div class="pagelist"> <a href="<?php echo APP?>/goodsType/search/keyword/<?php echo $keyword?>/page/<?php echo $currentPage-1?>">上一页</a> <span class="current"><?php echo $currentPage?></span><a href="<?php echo APP?>/goodsType/search/keyword/<?php echo $keyword?>/page/<?php echo $currentPage+1?>">下一页</a><a href="<?php echo APP?>/goodsType/search/keyword/<?php echo $keyword?>/page/<?php echo $totalPage?>">尾页</a> </div>
                <?php }?>
        </div>
    </div>
</div>
